		       ...
		       text: "职工车辆管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "StaffVehicle/staffVehicle_add.jsp"
			    	   	},
			    		{
			    	   		text: "职工车辆管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "StaffVehicle/staffVehicle_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "车辆进出管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "VehicleAccess/vehicleAccess_in.jsp"
			    	   	},
			    		{
			    	   		text: "车辆进出管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "VehicleAccess/vehicleAccess_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "校车车辆管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "SchoolBus/schoolBus_add.jsp"
			    	   	},
			    		{
			    	   		text: "校车车辆管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "SchoolBus/schoolBus_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻公告管理",
