...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">校内车辆管理</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>StaffVehicle/frontlist">职工车辆</a></li>
                <li><a href="<%=basePath %>VehicleAccess/frontlist">车辆进出</a></li>
                <li><a href="<%=basePath %>SchoolBus/frontlist">校车车辆</a></li>
